...
public class GPGTurnBasedMultiplayerUI : MonoBehaviourGUI
{
	...
	private void authenticatedWithNoMatchLoadedGUI()
	{
		...
		{
			GPGTurnBasedMultiplayer.createMatchProgrammatically( 1, 3, 0 );
		}
	...
	string getPendingParticipantId()
	{
		...
		// if minAutoMatchingPlayers is > 0 then we pass null as the next participant (which is an automatch player)
